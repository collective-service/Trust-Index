...
function initiateMap() {
    ...
    g = mapsvg.append("g").attr('id', 'countries')
          ...
          circles = mapsvg.append("g").attr('id', 'countries')
              .selectAll(".cercle")
              .data(cfmData)
              .enter()
              .append("g")
...
let cfmDataUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSUxYL-NH1hmHH6f-JrLSihW9dTog49ckVjWmaVC8a2q9LOaaTNuW3FUKQtL33JH-0khhWnbFaTSsKU/pub?gid=126026288&single=true&output=csv';
